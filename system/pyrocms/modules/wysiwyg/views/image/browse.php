...
function insertImage(file, alt)
{
	...
	window.parent.instance.insertHtml('<img class="pyro-image" style="float: '+get_float()+';" src="' + BASE_URI + 'uploads/size/'+img_width+'x'+img_height+'/files/' + file + '" alt="' + alt + '" width="'+img_width+'" />');
    	windowClose();
}
